// app.js - Sse Manager Ver 1.6.4 - SUPABASE DISABILITATO
console.log('🏗️ Sse Manager - Caricamento Ver 1.6.4...');

class SseManager {
    constructor() {
        this.supabaseConnected = false; // FORZO SUPABASE DISABILITATO
        this.operai = [];
        this.cantieri = [];
    ...
    init() {
        console.log('🚀 Inizializzazione Sse Manager Ver 1.6.4 - Solo localStorage');
        this.loadAllData();
    ...
    showConnectionStatus() {
        const statusMessage = '🗄️ Supabase: Disabilitato - usando localStorage';
    ...
    // TUTTE LE ALTRE FUNZIONI RIMANGONO IDENTICHE ALLA VERSIONE ORIGINALE
    setupEventListeners() {
        // Login
    ...
    renderCantieri() {
        ...
        // Drop sul container per rimuovere operai
    ...
    showInfo() {
        ...
        if (infoSection) {
            ...
            supabaseStatus.innerHTML = `
                ...
                <p><strong>Stato:</strong> ❌ Disabilitato</p>
                <p><strong>Dati:</strong> Salvati localmente</p>
                <p><em>Supabase è temporaneamente disabilitato per risolvere problemi di connessione</em></p>
            `;
