// app.js - Sse Manager Ver 1.2
console.log('🏗️ Sse Manager - Caricamento Ver 1.2...');
...
class SseManager {
    ...
    init() {
        console.log('🚀 Inizializzazione Sse Manager Ver 1.2');
    ...
    filterOperai(searchTerm) {
        ...
        if (!term) {
            operaiCards.forEach(card => card.style.display = 'block');
            return;
        }
